package com.mahibul.firebase_pushnotificatin_analytics.notification
...
import com.mahibul.firebase_pushnotificatin_analytics.ui.MassageShowActivity
import com.orhanobut.logger.Logger
import org.json.JSONException
import org.json.JSONObject

@Suppress("NULLABILITY_MISMATCH_BASED_ON_JAVA_ANNOTATIONS")
class FirebaseMessageNotification : FirebaseMessagingService() {
    ...
    private fun handleDataMessage(json: JSONObject) {
        ...
        try {
            ...
            val resultIntent = Intent(applicationContext, MassageShowActivity::class.java)
